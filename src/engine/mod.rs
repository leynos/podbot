...
pub use connection::{
    ...
    CredentialUploadResult, EngineConnector, ExecMode, ExecRequest, ExecResult, GitIdentityResult, HostCommandRunner, HostGitIdentity, InspectExecFuture, ResizeExecFuture, SelinuxLabelMode, SocketResolver, StartExecFuture, SystemCommandRunner, UploadToContainerFuture, configure_git_identity, read_host_git_identity,
};
